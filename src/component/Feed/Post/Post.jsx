      ...
      {isLoading ? (
        ...
        <>
          <div className="image" style={{ display: 'flex', justifyContent: 'space-between' }}>
            <div className="image">
              <img
                src={post.userid.profileimage ? post.userid.profileimage : unknownuser}
                alt=""
                onClick={() => navigate(`/profile/${post.userid._id}`)}
              />
              <span className="name">
                <b onClick={() => navigate(`/profile/${post.userid._id}`)}>
                  {post.userid.name ? post.userid.name : null}
                </b>
              </span>
            </div>
            <div>
          ...
          <Menu
            ...
            {userid === id || userid == post.userid._id ? (
